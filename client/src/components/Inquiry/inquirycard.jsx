...
import { FiUser, FiMail, FiPhone, FiBriefcase, FiTag, FiMessageSquare, FiFile, FiClock, FiRefreshCw ,FiSend} from 'react-icons/fi';
                        ...
                        <div>
                            {inquiry.assigned && (
                                <div className="text-xs text-gray-600">
                                    <span className="font-medium">Assigned to:</span> {inquiry.assigned}
                                </div>
                            )}
                            <div className="text-xs text-gray-600">
